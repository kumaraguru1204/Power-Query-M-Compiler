...
| Doc | Text.PadStart(text,width,pad) |

## Behaviour

Text.PadStart(text,width,pad)
...
Fixtures live under [conformance/functions/Text.PadStart/](../../conformance/functions/Text.PadStart/) (create the folder when adding fixtures).