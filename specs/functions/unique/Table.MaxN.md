...
| Doc | Table.MaxN(prev, n, col) |

## Behaviour

Table.MaxN(prev, n, col)
...
Fixtures live under [conformance/functions/Table.MaxN/](../../conformance/functions/Table.MaxN/) (create the folder when adding fixtures).